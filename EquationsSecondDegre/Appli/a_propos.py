...
def main():
    ...
    Label(prgm.about_root,text='-\u00A0Am\u00E9lioration de la compatibilit\u00E9 avec linux.').grid(column=0,row=1,sticky='w')
    Label(prgm.about_root,text='-\u00A0Am\u00E9lioration de l\u2019installation des packages.').grid(column=0,row=2,sticky='w')
