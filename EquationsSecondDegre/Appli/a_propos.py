...
def main():
    ...
    Label(__main__.about_root,text='-\u00A0Modification de la police.').grid(column=0,row=1,sticky='w')
    Label(__main__.about_root,text='-\u00A0Modification de l\u2019icone de la fen\u00EAtre \u00E0 propos.').grid(column=0,row=3,sticky='w')
