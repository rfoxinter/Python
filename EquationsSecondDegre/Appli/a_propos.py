...
def main():
    ...
    Label(prgm.about_root,text='-\u00A0Ajout du format .docx pour exporter.').grid(column=0,row=1,sticky='w')
    Label(prgm.about_root,text='-\u00A0Ajout du format .xhtml pour exporter.').grid(column=0,row=2,sticky='w')
