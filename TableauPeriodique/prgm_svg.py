try:
    ...
    system('echo Ce programme doit installer svgwrite pour fonctionner & timeout 30 & '+executable+' -m pip install --upgrade svgwrite')
    import svgwrite

dwg=svgwrite.Drawing(filename='Tableau.svg')
tableau=[('1','Hydrog\u00E8ne','H','1.0','2.2'),(),(),(),(),(),(),(),(),(),(),(),(),(),(),(),(),('2','H\u00E9lium','He','4.0',''),
    ('3','Lithium','Li','6.9','1.0'),('4','B\u00E9ryllium','Be','9.0','1.6'),(),(),(),(),(),(),(),(),(),(),('5','Bore','B','10.8','2.0'),('6','Carbone','C','12.0','2.5'),('7','Azote','N','14.0','3.0'),('8','Oxyg\u00E8ne','O','16.0','3.4'),('9','Fluor','F','19.0','4.0'),('10','N\u00E9on','Ne','20.2',''),
...
def draw_symbol(x,y,no,name,symb,M,electro):
    dwg.add(dwg.rect((x,y),(200,250),stroke=svgwrite.rgb(0,0,0,'rgb'),fill='none'))
    dwg.add(dwg.text(no,insert=(x+10,y+35),fill=svgwrite.rgb(255,0,255,'rgb'),stroke_width=2,style="text-anchor:start",font_size='40px',font_family="CMU Perso"))
    dwg.add(dwg.text(electro,insert=(x+190,y+35),fill=svgwrite.rgb(0,255,0,'rgb'),stroke_width=2,style="text-anchor:end",font_size='40px',font_family="CMU Perso"))
    dwg.add(dwg.text(symb,insert=(x+100,y+120),fill=svgwrite.rgb(0,0,0,'rgb'),stroke_width=2,style="text-anchor:middle",font_size='60px',font_family="CMU Perso"))
    dwg.add(dwg.text(name,insert=(x+100,y+170),fill=svgwrite.rgb(0,0,255,'rgb'),stroke_width=2,style="text-anchor:middle",font_size='30px',font_family="CMU Perso"))
    dwg.add(dwg.text(M,insert=(x+100,y+235),fill=svgwrite.rgb(50,200,200,'rgb'),stroke_width=2,style="text-anchor:middle",font_size='40px',font_family="CMU Perso"))
...
dwg.add(dwg.text('Lathanides \u2192',insert=(425,2175),fill=svgwrite.rgb(0,0,0,'rgb'),stroke_width=2,style="text-anchor:end",font_size='60px',font_family="CMU Perso"))
dwg.add(dwg.text('Actinides \u2192',insert=(425,2425),fill=svgwrite.rgb(0,0,0,'rgb'),stroke_width=2,style="text-anchor:end",font_size='60px',font_family="CMU Perso"))
